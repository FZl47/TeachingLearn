...
function SubmitLogin() {
    ...
    if (StateLogin) {
        ...
        SendAjax('/s/LoginRegister/LoginCheck', Data, 'POST', function (response) {
...
function SubmitRegister() {
    ...
    if (StateRegister) {
        ...
        SendAjax('/s/LoginRegister/RegisterCheck', Data, 'POST', function (response) {
            let Status = response.Status
            if (Status == '200') {
